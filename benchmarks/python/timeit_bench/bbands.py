...
def benchmark_bbands():
    ...
    duration = timeit.timeit(lambda: tb.bbands(data, 20), number=iterations)
    ...
    duration = timeit.timeit(lambda: tb.bbands(data, 20, ma_type=tb.BBandsMA.EMA), number=iterations)
    average_time_rs = duration / iterations
